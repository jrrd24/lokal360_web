...
function PartnerShopContent() {
  const [isVisible, setIsVisible] = useState(false);

  useEffect(() => {
    const handleScroll = () => {
      const boxElements = document.querySelectorAll(".animated-box");
      boxElements.forEach((box, index) => {
        const boxTop = box.getBoundingClientRect().top;
        const screenHeight = window.innerHeight;
        if (boxTop < screenHeight && !isVisible) {
          setTimeout(() => setIsVisible(true), index * 500); // Adjust the delay as needed
        }
      });
    };
    ...
    <div>
      ...
      <Box sx={{ ...classes.titleSection }}>
        ...
        <Box sx={{ ...classes.titleContainer }}>
          <Box sx={{ textAlign: "left", lineHeight: "8vh" }}>
            <Typography fontWeight={600} sx={{ fontSize: "5vh" }}>
              Become a
            </Typography>
            <Typography fontWeight={600} sx={{ ...classes.titleFontStyle }}>
              360 Partner
            </Typography>
            <Typography fontWeight={600} sx={{ fontSize: "5vh" }}>
              Today
          ...
          <Typography variant="body" sx={{ textAlign: "left" }}>
            "Join our premium plan today and discover a world of exciting
            features and friendly support that will help your online store
            thrive like never before – we can't wait to see your business
            succeed!"
          </Typography>
          ...
          <Box>
            <Button
              variant="outlined"
              sx={{ mt: 5, "@media (max-width: 600px)": { mt: 3 } }}
            >
              <Typography
                variant="sectionTitleSmall"
                sx={{ color: "inherit", fontSize: 18, p: 0.5 }}
              >
                Get Started
              </Typography>
            </Button>
          ...
          <Partner
            sx={{
              ...
              "@media (max-width: 1200px)": {
                ...
                height: "auto", // Allows the aspect ratio to be maintained
              },
            }}
          />
        </Box>
      ...
      <Box sx={{ ...classes.svgContainer }}>
        ...
        <Box sx={{ ...classes.featuresContainer }}>
          {/*Lokal Ads */}
          <Box
            ...
            sx={{
              ...
              transition:
                "opacity 0.7s cubic-bezier(0.075, 0.82, 0.165, 1) 0.7s, transform 0.7s cubic-bezier(0.075, 0.82, 0.165, 1) 0.7s",
              ...classes.features,
            }}
          >
            {/*Feature details container */}
            <Stack spacing={2} sx={{ py: 5, px: 2 }}>
              {/*Icon Container */}
              <Box sx={{ ...classes.iconContainer }}>
                {/*Icon */}
                <Box sx={{ ...classes.featuredIconCircle }}>
                  <Campaign
                    sx={{
                      ...classes.featuredIcon,
              ...
              <Box>
                <Typography variant="body" sx={{ ...classes.description }}>
                  Gain more eyes on your products through{" "}
                  <b>Shop and Sitewide Advertisments</b>
                </Typography>
              </Box>
            </Stack>
          </Box>
          ...
          <Box
            className={`animated-box ${isVisible ? "visible" : ""}  `}
            sx={{
              backgroundColor: theme.palette.status.preparing,
              //transition
              opacity: isVisible ? 1 : 0,
              transform: isVisible ? "translateY(0)" : "translateY(50px)",
              transition:
                "opacity 1.0s cubic-bezier(0.075, 0.82, 0.165, 1) 1.0s, transform 1.0s cubic-bezier(0.075, 0.82, 0.165, 1) 1.0s",
              ...classes.features,
            }}
          >
            {/*Feature details container */}
            <Stack spacing={2} sx={{ py: 5, px: 2 }}>
              ...
              <Box>
                <Typography variant="body" sx={{ ...classes.description }}>
                  Create and distribute <b>Digital Vouchers</b> to attract
          ...
          <Box
            className={`animated-box ${isVisible ? "visible" : ""}  `}
            sx={{
              backgroundColor: theme.palette.status.pickUp,
              //transition
              opacity: isVisible ? 1 : 0,
              transform: isVisible ? "translateY(0)" : "translateY(50px)",
              transition:
                "opacity 1.3s cubic-bezier(0.075, 0.82, 0.165, 1) 1.3s, transform 1.3s cubic-bezier(0.075, 0.82, 0.165, 1) 1.3s",
              ...classes.features,
            }}
          >
            {" "}
            ...
            <Stack spacing={2} sx={{ py: 5, px: 2 }}>
              ...
              <Box>
                <Typography variant="body" sx={{ ...classes.description }}>
                  Personalize the <b>Visual Aesthetics</b> of your online store
                </Typography>
              </Box>
            </Stack>
          </Box>
          ...
          <Box
            className={`animated-box ${isVisible ? "visible" : ""} `}
            sx={{
              backgroundColor: theme.palette.status.delivery,
              //transition
              opacity: isVisible ? 1 : 0,
              transform: isVisible ? "translateY(0)" : "translateY(50px)",
              transition:
                "opacity 1.6s cubic-bezier(0.075, 0.82, 0.165, 1) 1.6s, transform 1.6s cubic-bezier(0.075, 0.82, 0.165, 1) 1.6s",
              ...classes.features,
            }}
          >
            {" "}
            ...
            <Stack spacing={2} sx={{ py: 5, px: 2 }}>
              ...
              <Box>
                <Typography variant="body" sx={{ ...classes.description }}>
                  360 Partners would have their Shop and Products featured on
                  the <b>Homepage</b> of the App
                </Typography>
              </Box>
            </Stack>
          </Box>
...
const classes = {
  ...
  titleContainer: {
    maxWidth: "40%",
    textAlign: "left",
    "@media (max-width: 900px)": { maxWidth: "80%" },
  },
  titleFontStyle: {
    fontSize: "10vh",
    lineHeight: "inherit",
...
const Partner = ({ sx }) => {
  return (
    <Box sx={{ ...sx }}>
      ...
      >
        <title>360 Partner</title>
        <circle cx="578.6059" cy="373.0001" r="373.0001" fill="#f2f2f2" />
        <circle cx="692.60735" cy="136.00133" r="97.00003" fill="#ff6584" />
        <path
        ...
        <path
          ...
          opacity="0.1"
        />
        <ellipse cx="522.608" cy="634.00135" rx="514" ry="81" fill="#3f3d56" />
        <path
        ...
        <path
          ...
          opacity="0.1"
        />
        <ellipse cx="746.608" cy="640.00135" rx="126" ry="27" opacity="0.1" />
        <polygon
...
export default PartnerShopContent;
